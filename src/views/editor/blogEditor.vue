            ...
            <div style="width: 80%; margin: 0 3%">
              ...
              <div style="margin-top: 10px; background-color: whitesmoke">
                <div style="background-color: cornflowerblue">
                  ...
                  <el-button style="margin-left: 20px;color: gainsboro" size="medium" type="text" @click="addBlogType()">+ 新建分类</el-button>
                </div>
                <el-form style="margin-top: 10px">
                  <el-form-item prop="content">
              ...
              <div style="justify-content: left; display: flex; align-items: center; height: 50px">
                <div>
                  ...
                  <el-button type="primary" style="background-color: #3366cc;" size="medium" @click="clearForm()">取消</el-button>
                </div>
              </div>
            </div>
          </div>
        ...
        <el-dialog  :visible.sync="addTypeFormVisible" width="30%" @click='closeDialog("edit")'>
          <el-form label-width="80px" ref="editAddTypeForm" :model="editAddTypeForm" :rules="rules">
            <el-form-item label="名称" prop="name">
              <el-input size="small" v-model="editAddTypeForm.name" auto-complete="off" placeholder="请输入分类名称"></el-input>
            </el-form-item>
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button size="small" type="primary" class="title" @click="submitAddForm('editAddTypeForm')">保存</el-button>
          </div>
        </el-dialog>
      </div>
    </el-container>
...
export default {
  ...
  methods: {
    ...
    clearForm() {
      const confirmed = confirm('确认要清空吗？');
      if (confirmed) {
